<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SubFamilias.aspx.cs" Inherits="DMC.DMC.Productos.WebForm5" %>
...
.flex-column-items {
    ...
    <asp:Panel ID="PanelActualizar" runat="server" CssClass="modal-panel" Visible="False">
        <div class="modal-content">
            ...
            <div class="mb-3">
                <asp:Label ID="LblCodigoFa" runat="server" Text="Codigo SubFamilia:" CssClass="form-label"></asp:Label>
                <asp:TextBox ID="TextSubFamilia" runat="server" CssClass="form-control"></asp:TextBox>
            </div>

            <div class="mb-3">
                <asp:Label ID="LblDescrip" runat="server" Text="Descripción:" CssClass="form-label"></asp:Label>
    ...
    <asp:Panel ID="PanelAgrearFa" runat="server" CssClass="modal-panel" Visible="False">
        <div class="modal-content">
            ...
            <div class="mb-3">
                ...
                <asp:DropDownList ID="ddlFamilia" runat="server" CssClass="form-control" AutoPostBack="false">
                </asp:DropDownList>
            </div>

            <div class="mb-3">
                <asp:Label ID="Label2" runat="server" Text="Codigo SubFamilia:" CssClass="form-label"></asp:Label>
                <asp:TextBox ID="AgreCodigoSubFamilia" runat="server" CssClass="form-control"></asp:TextBox>
            </div>

            <div class="mb-3">
                <asp:Label ID="txtAgreFamilia" runat="server" Text="Descripción:" CssClass="form-label"></asp:Label>
                <asp:TextBox ID="AgregarDescripSubFamilia" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
    ...
    <div id="GridViewSubFamiliaCss">

    <asp:GridView ID="GridViewSubFamilia" runat="server" AutoGenerateColumns="false" OnRowCommand="GridViewServicios_RowCommand" OnRowEditing="GridViewBodega_RowEditing" DataKeyNames="id_SubFamilia">
        <Columns>
            <asp:BoundField DataField="id_SubFamilia" HeaderText="#" HeaderStyle-Width="30px"/>
            <asp:BoundField DataField="codigo_SubFamilia" HeaderText="Codigo" HeaderStyle-Width="70px"/>
            <asp:BoundField DataField="descripcion" HeaderText="Descripción" HeaderStyle-Width="80px"/>
            <asp:BoundField DataField="descripcionFa" HeaderText="Familia" HeaderStyle-Width="70px"/>
            <asp:BoundField DataField="activo" HeaderText="Activo" HeaderStyle-Width="30px"/>

            <asp:TemplateField HeaderText="Editar" HeaderStyle-Width="50px">
                <ItemTemplate>
                    <asp:Button ID="lnkEditar" runat="server" Text="Editar" CommandName="Edit" CommandArgument='<%# Eval("id_SubFamilia") %>'  onclick="MostrarEditar"/>
                </ItemTemplate>
            </asp:TemplateField>

            <asp:TemplateField HeaderText="Agregar" HeaderStyle-Width="50px">
                <ItemTemplate>
                    <asp:Button ID="btdesactivar" runat="server" Text="Agregar" CommandName="Agregar" CommandArgument='<%# Container.DataItemIndex %>' OnClick="MostrarAgregar"/>
                </ItemTemplate>
            </asp:TemplateField>

            <asp:TemplateField HeaderText="A/D" HeaderStyle-Width="30px">
                <ItemTemplate>
